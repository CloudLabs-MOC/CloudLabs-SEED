<a name="br1"></a>SEED Labs – BGP Exploration and Attack 1
...
2\.2 Modifying the BGP Conﬁguration File
...
\# birdc configure BIRD 2.0.7 ready.
...
` `route 10.130.0.0/16 blackhole { bgp\_large\_community.add(LOCAL\_COMM); };}
