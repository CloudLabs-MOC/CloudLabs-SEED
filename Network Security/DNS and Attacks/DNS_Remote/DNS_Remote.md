...
attack technique, called DNS Cache Poisoning attack. In another SEED Lab, we have designed activities to
...
machine, so the server 10.9.0.53 is added as the first nameserver entry in the file, i.e., this server will
...
***Get the IP address of www.example.com**. Two nameservers are now hosting the example.com
