...
The second command generates a KSK. The -f option put 257 in the key file, indicating this is the
...
;; ANSWER SECTION:
www.example.edu 259200 IN A 1.2.3.
