...
On HostU,telnetto HostV. While keeping the telnet connection alive, we break the VPN tunnel by
...
and tunserver.py programs again, and set up their TUN interfaces and routing (this is where you can
...
![image](https://github.com/CloudLabs-MOC/CloudLabs-SEED/assets/33658792/077c2407-9475-4ec2-a4ad-ae861e90becd)
